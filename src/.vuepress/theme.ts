...
export default hopeTheme({
  // 当前网站部署到的域名
  hostname: "https://gitee.com/mfx-easy",

  // 文章显示的默认作者
  author: {
    name: "mcode",
    url: "https://gitee.com/mfx-easy",
  },
  ...
  // 文章所在仓库
  docsRepo: "https://gitee.com/mfx-easy/docs.git",
  ...
  blog: {
    ...
    roundAvatar: false,
    // 个人描述
    description: "不积畦步,无以至千里,不积小流,无以成江海！",
    // 社交媒体
    medias: {
      Gitee: "https://gitee.com/mfx-easy",
    },
    // 博客的侧边栏设置
