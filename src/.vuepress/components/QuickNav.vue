<template>
  <el-tabs tab-position="left" style="height: 600px">
    <!-- 标签页 -->
    <el-tab-pane v-for="(i, index) in nav" :label="i.category" :key="index">
      <!-- 使用珊格操作 -->
      <el-scrollbar height="600px">
        <el-row
          :gutter="10"
          v-for="(j, index) in Math.ceil(i.items.length / 2)"
          :key="index"
        ...
        >
          ...
          <el-col :span="12" v-if="i.items[index * 2] != null">
            ...
            >
              {{
                i.items[index * 2].isPerfect
                  ? i.items[index * 2].title + "⚡️"
                  : i.items[index * 2].title
              }}
            </el-card>
          </el-col>
          <el-col :span="12" v-if="i.items[index * 2 + 1] != null">
            ...
            >
              {{
                i.items[index * 2 + 1].isPerfect
                  ? i.items[index * 2 + 1].title + "⚡️"
                  : i.items[index * 2 + 1].title
              }}
            </el-card>
          </el-col>
        </el-row>
